  ...
  return (
    <div className="min-h-screen bg-gray-50 p-8">
      <div className="max-w-7xl mx-auto space-y-8">
        ...
        {/* Insights - now split into 2 columns */}
          ...
          <table className="w-full text-sm">
            ...
            <tbody>
              {candidates.map((candidate) => {
                const candidateRequests = filteredRequests.filter((r) => r.candidate_id === candidate.id);
                ...
                return (
                  <>
                    ...
                    >
                      ...
                      <td className="p-4 text-sm text-gray-600">{candidateRequests.length} referees</td>
                    </tr>
                              ...
                              {candidateRequests.map((req) => {
                                ...
                                return (
                                  <tr key={req.id} className="border-b hover:bg-gray-50 transition">
                                    ...
                                    <td className="p-3 w-1/6 text-gray-600 text-xs">Sent {req.resend_count || 0} times</td>
